...
\begin{tabular}{lllll}
\hline
\textbf{ImageTarget $i$}  & \textbf{$d$}  & \textbf{$\omega_{xi}$}  & \textbf{$\omega_{yi}$} & \textbf{$\omega_{xi}$}    \\
\hline
&\\
