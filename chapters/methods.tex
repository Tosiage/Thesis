...
Das Vuforia Developer Portal bietet eine Bewertung von 0 bis 5 Sternen für hochgeladene Bilder an. Diese Bewertung sagt aus, wie gut sich das Bild als Image Target eignet. Ein Bild, welches als Image Target verwendet werden soll, sollte:
\begin{itemize}
...
Die image targets die ich genutzt habe.
